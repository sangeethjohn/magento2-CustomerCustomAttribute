 ...
 * @version    1.0.0
 */
namespace Macfadyen\CustomerCustomAttributes\Block\Widget;
 ...
 */
class AddressType extends \Magento\Customer\Block\Widget\AbstractWidget
{
    
    /**
     * the attribute code
     */
    const ATTRIBUTE_CODE = 'address_type';
    ...
    public function _construct()
    {
        ...
        $this->setTemplate('widget/address-type.phtml');
    }
    ...
    /**
     * Returns options from address_type attribute
     * @return OptionInterface[]
     */
    public function getAddressTypeOptions()
    {
        return $this->_getAttribute('address_type')->getOptions();
    }
}
